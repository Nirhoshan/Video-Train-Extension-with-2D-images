...
if __name__ == '__main__':
    ...
    DATA_DIR = 'gasf_60_train/Youtube/vid1'
    ...
    generator.load_state_dict(torch.load('weights60/G60yt600-gm.pth'))
    discriminator.load_state_dict(torch.load('weights60/D60yt600-gm.pth'))
    #discriminator.load_state_dict(torch.load('weights80/D80stan500-gm.pth'))
