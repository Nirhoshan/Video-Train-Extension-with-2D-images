...
def save_samples(index, latent_tensors, show=True):
    ...
    for j in range(fake_no):
        ...
        # if index==200:
        fake_fname = f'3-generated-csv-{str(index).zfill(5)}-{str(j).zfill(5)}.csv'
...
def fit(epochs, lr, start_idx=1):
    ...
    for epoch in range(epochs):
        ...
        if epoch%50==0:
            torch.save(generator.state_dict(), 'weights60/G60stan' + str(epoch) +'-gm.pth')
            torch.save(discriminator.state_dict(), 'weights60/D60stan' + str(epoch) +'-gm.pth')
...
if __name__ == '__main__':
    ...
    DATA_DIR = 'gasf_60_pretrain_Youtube'
    ...
    torch.save(generator.state_dict(), 'weights60/G60stan600_gm.pth')
    torch.save(discriminator.state_dict(), 'weights60/D60stan600_gm.pth')

    from IPython.display import Image

    Image('./generated3/3generated-images-0001.png')
  ...
  #  plt.title('Scores');
    ...
    plt.savefig("cosine_similarity_1.png")
    plt.clf()
    plt.plot(eud)
    plt.savefig("euclidean_distance_1.png")
    plt.clf()
    plt.plot(ssim_scores)
    plt.savefig("ssim_score_1.png")
    plt.clf()
    plt.plot(mses)
    plt.savefig("mses_1.png")
    plt.show()