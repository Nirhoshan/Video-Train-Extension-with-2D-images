...
discriminator = nn.Sequential(
    ...
    nn.Conv2d(1, 16, kernel_size=3, stride=2, padding=3, bias=False),
...
generator = nn.Sequential(
    ...
    nn.ConvTranspose2d(16, 1, kernel_size=3, stride=2, padding=3, bias=False),
    nn.Tanh()
    # out: 3 x 64 x 64
)
...
if __name__ == '__main__':
    ...
    DATA_DIR = 'gasf_csv_bin4_40_train/Stan/vid1'
    ...
    generator.load_state_dict(torch.load('weights/Gstan600-gm.pth'))
    discriminator.load_state_dict(torch.load('weights/Dstan600-gm.pth'))
   ...
   # print(cos_similarity)
    ...
    #plt.savefig("cosine_similarity_3.png")
    #plt.clf()
    #plt.plot(eud)
    #plt.savefig("euclidean_distance_3.png")
    plt.clf()
    plt.plot(ssim_scores)
    plt.savefig("ssim_score_3.png")
    plt.clf()
    plt.plot(mses)
    plt.savefig("mses_3.png")
    plt.clf()
    plt.plot(mfids)
    plt.savefig("fid_3.png")
    plt.show()