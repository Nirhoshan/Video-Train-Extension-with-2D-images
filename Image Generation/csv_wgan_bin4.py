...
def fit(epochs, lr, start_idx=1):
    ...
    for epoch in range(epochs):
        ...
        if epoch%50==0:
            torch.save(generator.state_dict(), 'G64net' + str(epoch) +'.pth')
            torch.save(discriminator.state_dict(), 'D64net' + str(epoch) +'.pth')
...
if __name__ == '__main__':
    ...
    DATA_DIR = 'gasf_csv_bin4_40_pretrain_Netflix'
    ...
    torch.save(generator.state_dict(), 'G_netflix.pth')
    torch.save(discriminator.state_dict(), 'D_netflix.pth')

    from IPython.display import Image

    Image('./generated0/0generated-images-0001.png')
