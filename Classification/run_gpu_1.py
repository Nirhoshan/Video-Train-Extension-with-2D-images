...
def run_vid_clf(x_train, y_train, x_test, y_test, platform, synth_size, random_state, bin_size, train_data_size):
    ...
    path_to_save = 'dl_clf_synth/results/diff_bin_size_analysis_with_synth_data_reduced_act_traces/gasf/' + '/' + 'split_the_traces_in_a_video' + '/' + \
    ...
    for bin in bins:
        ...
        for p in range(3):
            ...
            for r in range(3):
                ...
                all_synth_acc = []
                for synth_size in range(30, 301, 30):
                ...
                # store the data
                columns = list(np.arange(30, 301, 30).astype(str))
