...
def run_vid_clf(x_train, y_train, x_test, y_test, platform, synth_size, random_state, bin_size,train_data_size):
    ...
    print('Random_set ' + str(random_state) + ' Synth size ' + str(synth_size) + 'Training data size'+str(train_data_size)+ ' Accuracy ' + str(accuracy))
    print('=================')
    # print('train model')
    ...
    path_to_save = 'data_clf3/results/diff_bin_size_analysis_with_synth_data_reduced_act_traces/gasf/' + '/' + 'split_the_traces_in_a_video' + '/' + \
...
def main():
    ...
    for bin in bins:
        ...
        for p in range(3):
            if p != platform:
                continue
            for train_data_size in range(43,max_train_data_size+1,3):
                ...
                for r in range(4):
                    ...
                    for synth_size in range(0, 31,5):
                    ...
                    # store the data
                    columns = list(np.arange(0, 31, 5).astype(str))
